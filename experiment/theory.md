...
- Example-2: For $(3,2)$ SPC code, the messages and the
    ...
    \end{bmatrix} ,
    \end{align*}$$
     where the matrix $G$ = $$\begin{align*}\begin{bmatrix} 1 & 0 & 1 \\ 0 & 1 & 1\end{bmatrix}\end{align*}$$ is a generator matrix of $(3,2)$ SPC code.

- Example-3: Consider the following generator matrix.
$G$ = $$\begin{align*}\begin{bmatrix} 1 & 0 & 0 & 1 \\ 0 & 1 & 1 & 1  \\\end{bmatrix} \end{align*}$$
...
$$\begin{align*}\begin{bmatrix} 1 & 0 \end{bmatrix}\end{align*}$$ \times 
...
$G$ = $$\begin{align}\begin{bmatrix} 
1 & 0 & 1 \\ 
0 & 1 & 1  \\
\end{bmatrix}\end{align}$$
= $$\begin{align}\begin{bmatrix} I_2 & P\end{bmatrix}\end{align}$$
\hspace{0.05in}{where} \hspace{0.05in}{} 
$$\begin{align}I_2 = \begin{bmatrix} 
1 & 0 \\ 
0 & 1  \\
\end{bmatrix}\end{align}$$
...
\end{align}$$
= $$\begin{align}\begin{bmatrix} I_2 & P\end{bmatrix} \end{align}$$
, I_2 = $$\begin{align}\begin{bmatrix} 
1 & 0 \\ 
0 & 1  \\
\end{bmatrix} \end{align}$$
\hspace{0.05in}{and} \hspace{0.05in}{} 
$$\begin{align}P^{\prime} = \begin{bmatrix} 
0 & 1 \\ 
