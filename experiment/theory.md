...
- **Example-1:** For REP-$3$ code, the codewords corresponding to messages
  ...
  $$
  \begin{aligned}
  \begin{bmatrix} 0 & 0 & 0 \end{bmatrix} &= [0]   \begin{bmatrix} 1 & 1 & 1\end{bmatrix}   \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 0 & 1 \end{bmatrix} \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix} \\
&= 0.
\end{align*}
$$
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 1 & 1 \end{bmatrix} \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix} \\
&= 1.
\end{align*}
$$
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 0 & 0 & 1 \end{bmatrix}
\begin{bmatrix}
0 & 1 \\
1 & 1 \\
1 & 0 \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 1 & 1 & 1 \end{bmatrix}
\begin{bmatrix}
0 & 1 \\
1 & 1 \\
1 & 0 \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 1 & 1 & 0 \end{bmatrix}
\begin{bmatrix}
0 & 1 \\
1 & 1 \\
1 & 0 \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 1 & 1 & 0 & 0 \end{bmatrix}
\begin{bmatrix}
1 & 1 \\
1 & 0 \\
0 & 1 \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 0 & 1 & 0 & 1 & 0 \end{bmatrix}
\begin{bmatrix}
1 & 1 \\
1 & 0 \\
0 & 1 \\
...
$$
\begin{align*}
\mathbf{v}H^T &= \begin{bmatrix} 1 & 0 & 1 & 1 & 0 & 1 \end{bmatrix}
\begin{bmatrix}
1 & 1 \\
1 & 0 \\
0 & 1 \\
...
$$
\begin{align*}
GH^T &= \begin{bmatrix} 1 & 0 & 1\\ 0 & 1 & 1\end{bmatrix} \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix} \\
&= \begin{bmatrix} 0 \\ 0 \end{bmatrix}. \checkmark
\end{align*}
$$
