...
function getCnt() {
    cnt=0;
    for (var i = 0; i < array.length; i++) {
        if (array[i] === "w1" || array[i] === "w3" || array[i] === "w6" || array[i] === "w7" ||
            array[i] === "w9" || array[i] === "w11" || array[i] === "w13" || array[i] === "w14") {
            cnt++;
        }
        else if (array[i] === "w2" || array[i] === "w4" || array[i] === "w5" || array[i] === "w8" ||
            array[i] === "w10" || array[i] === "w12" || array[i] === "w15") {
            cnt--;
        }
    }
}
